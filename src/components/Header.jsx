      ...
      <div className="bg-brand-navy text-slate-200 text-xs py-2 px-4 border-b border-slate-800">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-4">
            <a 
              href="tel:+918043812772" 
              className="flex items-center gap-1.5 hover:text-white transition-colors"
            >
              <Phone className="w-3.5 h-3.5 text-brand-green" />
              <span>+91 8043812772</span>
            </a>
            <span className="text-slate-600">|</span>
            <a 
              href="https://wa.me/918043812772?text=Hello%20Medihub%20Pharma%20Labs,%20I%20want%20to%20inquire%20about%20pharmaceutical%20products" 
              target="_blank" 
