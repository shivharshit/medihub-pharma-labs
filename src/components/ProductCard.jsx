    ...
    >
      ...
      <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
        ...
        <div className="pt-2 border-t border-slate-100 grid grid-cols-2 gap-2">
          ...
          <a
            href={`https://wa.me/918043812772?text=Hello%20Medihub%20Pharma%20Labs,%20I%20am%20interested%20in%20product:%20${encodeURIComponent(product.name)}%20(${encodeURIComponent(product.dosage || '')}).%20Please%20provide%20export%20quotation%20and%20MOQ.`}
            target="_blank"
